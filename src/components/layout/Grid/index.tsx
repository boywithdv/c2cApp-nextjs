// Gridコンポーネント---------- Boxコンポーネントを継承し、Flexboxに関する設定を簡単に行う
...
// GridProps --------- Gridコンポーネントに適用できるプロパティの型定義を提供
// BoxPropsを継承している
 ...
 * gridレイアウトの実現に利用する
 */
// GridコンポーネントをBoxコンポーネントをベースにして作成。GridPropsを型引数として指定
const Grid = styled(Box)<GridProps>`
  // 各プロパティに対してtoPropvalueを使用して　---------- CSSプロパティと値の文字をかえす
