import {Search,PersonOutline,ShoppingCart,CheckBoxOutlineBlank,CheckBox,Cancel,CloudUpload,Close,GitHub,Person,} from '@mui/icons-material'
...
function withIconStyle(
  ...
  const IconWithStyle = (props: IconButtonProps) => {
    const { onClick, className, size = 30, ...rest } = props
